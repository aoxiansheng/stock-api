 ...
 */
export class DataTransformResponseDto<T = unknown> {
  @ApiProperty({ description: "转换后的业务数据" })
  transformedData: T;

  @ApiProperty({
    description: "数据转换元信息",
    type: DataTransformationMetadataDto,
  })
  metadata: DataTransformationMetadataDto;

  constructor(transformedData: T, metadata: DataTransformationMetadataDto) {
