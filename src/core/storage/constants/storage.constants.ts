...
/**
 * @deprecated 请使用 PERFORMANCE_CONSTANTS.RESPONSE_TIME_THRESHOLDS.SLOW_STORAGE_MS
 * 保持向后兼容性的性能阈值映射
 */
...
/**
 * @deprecated 请使用 CACHE_CONSTANTS.TTL_SETTINGS 和 SIZE_LIMITS
 * 保持向后兼容性的缓存配置映射
 */
export const UNIFIED_CACHE_CONFIG = Object.freeze({
  ...
  CACHE_KEY_PREFIX: CACHE_CONSTANTS.KEY_PREFIXES.STORAGE,
  ...
  COMPRESSION_THRESHOLD_KB: CACHE_CONSTANTS.SIZE_LIMITS.COMPRESSION_THRESHOLD_KB,
});
...
export const UNIFIED_ERROR_MESSAGES = Object.freeze({
  STORAGE_FAILED: OPERATION_CONSTANTS.CRUD_MESSAGES.SAVE_FAILED,
  RETRIEVAL_FAILED: OPERATION_CONSTANTS.CRUD_MESSAGES.QUERY_FAILED,
  DELETE_FAILED: OPERATION_CONSTANTS.CRUD_MESSAGES.DELETE_FAILED,
...
export const UNIFIED_SUCCESS_MESSAGES = Object.freeze({
  STORAGE_SUCCESS: OPERATION_CONSTANTS.CRUD_MESSAGES.SAVE_SUCCESS,
  RETRIEVAL_SUCCESS: OPERATION_CONSTANTS.CRUD_MESSAGES.QUERY_SUCCESS,
