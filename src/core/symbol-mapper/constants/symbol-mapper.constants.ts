...
export const SYMBOL_MAPPER_OPERATIONS = Object.freeze({
  ...
  GET_MAPPING_RULES: "getMappingRules",
  GET_MAPPING_BY_ID: "getMappingById",
  GET_MAPPING_BY_DATA_SOURCE: "getMappingByDataSource",
  GET_MAPPINGS_PAGINATED: "getMappingsPaginated",
  ...
  DELETE_MAPPINGS_BY_DATA_SOURCE: "deleteMappingsByDataSource",
  ADD_MAPPING_RULE: "addMappingRule",
  UPDATE_MAPPING_RULE: "updateMappingRule",
  REMOVE_MAPPING_RULE: "removeMappingRule",
  REPLACE_MAPPING_RULES: "replaceMappingRules",
  APPLY_MAPPING_RULES: "applyMappingRules",
