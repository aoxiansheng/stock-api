...
export const ExtractedFieldSchema = SchemaFactory.createForClass(ExtractedField);
...
export const DataSourceTemplateSchema = SchemaFactory.createForClass(DataSourceTemplate);
