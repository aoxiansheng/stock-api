...
/**
 * @deprecated 请使用 PERFORMANCE_CONSTANTS.RESPONSE_TIME_THRESHOLDS.SLOW_REQUEST_MS
 * 保持向后兼容性的性能阈值映射
 */
...
export const UNIFIED_CACHE_CONFIG = Object.freeze({
  ...
  CACHE_KEY_PREFIX: CACHE_CONSTANTS.KEY_PREFIXES.RECEIVER,
...
export const UNIFIED_ERROR_MESSAGES = Object.freeze({
  ...
  OPERATION_FAILED: OPERATION_CONSTANTS.CRUD_MESSAGES.QUERY_FAILED, // 使用查询失败作为通用操作失败
