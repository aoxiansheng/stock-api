...
@Injectable()
export class InfrastructureMetricsRegistryService implements OnModuleInit, OnModuleDestroy {
  private readonly logger = createLogger(InfrastructureMetricsRegistryService.name);
