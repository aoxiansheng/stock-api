...
export class MetricsHelper {
   ...
   */
  static inc(
    registry: InfrastructureMetricsRegistryService, 
    name: string, 
    labels?: object, 
    value: number = 1,
    legacyCallback?: () => void
   ...
   * @param name 指标名称
   */
  static getCounter(registry: InfrastructureMetricsRegistryService, name: string) {
   ...
   * @param name 指标名称
   */
  static getGauge(registry: InfrastructureMetricsRegistryService, name: string) {
    return registry[name];
  }
   ...
   * @param name 指标名称
   */
  static getHistogram(registry: InfrastructureMetricsRegistryService, name: string) {
    return registry[name];
  }
