...
export const REDIS_CACHE_HIT_RATE_WARNING_THRESHOLD = 0.70;     // 70% - Efficiency threshold
export const REDIS_CACHE_HIT_RATE_POOR_THRESHOLD = 0.50;        // 50% - Utility threshold
export const REDIS_CACHE_HIT_RATE_CRITICAL_THRESHOLD = 0.30;    // 30% - Waste threshold
...
export type HealthLevel = 'excellent' | 'good' | 'warning' | 'poor' | 'critical';
export type AlertSeverity = 'info' | 'warning' | 'critical' | 'emergency';
export type CacheOperation = 'get' | 'set' | 'delete' | 'exists' | 'expire' | 'evict';
export type DatabaseOperation = 'select' | 'insert' | 'update' | 'delete' | 'aggregate' | 'index' | 'transaction';
