...
// 监控模块专用的状态值数组
export const MONITORING_BASIC_HEALTH_STATUS_VALUES: MonitoringHealthStatus[] =
  BASIC_HEALTH_STATUS_VALUES;
export const MONITORING_EXTENDED_HEALTH_STATUS_VALUES: MonitoringHealthStatus[] =
 ...
 */
export function isValidMonitoringStatus(
  status: any,
): status is MonitoringHealthStatus {
  return EXTENDED_HEALTH_STATUS_VALUES.includes(
    status as MonitoringHealthStatus,
  );
}
 ...
 */
export function getMonitoringStatusSeverity(
