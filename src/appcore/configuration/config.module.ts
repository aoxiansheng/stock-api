  ...
  imports: [
    ConfigModule.forRoot({
      ...
      validationSchema: Joi.object({
        ...
        CACHE_MONITORING_TTL: Joi.number().integer().min(60).max(3600).optional(),
        CACHE_AUTH_TTL: Joi.number().integer().min(60).max(3600).optional(),
        CACHE_TRANSFORMER_TTL: Joi.number().integer().min(60).max(1800).optional(),
        CACHE_SUGGESTION_TTL: Joi.number().integer().min(60).max(1800).optional(),
        CACHE_LONG_TERM_TTL: Joi.number().integer().min(300).max(86400).optional(),
        ...
        CACHE_MAX_BATCH_SIZE: Joi.number().integer().min(1).max(1000).optional(),
        CACHE_MAX_SIZE: Joi.number().integer().min(1000).max(100000).optional(),
        CACHE_LRU_SORT_BATCH_SIZE: Joi.number().integer().min(100).max(10000).optional(),
        SMART_CACHE_MAX_BATCH: Joi.number().integer().min(10).max(1000).optional(),
        ...
        QUICK_TIMEOUT_MS: Joi.number().integer().min(1000).max(30000).optional(),
        DEFAULT_TIMEOUT_MS: Joi.number().integer().min(5000).max(300000).optional(),
        LONG_TIMEOUT_MS: Joi.number().integer().min(30000).max(600000).optional(),
        CONNECTION_TIMEOUT_MS: Joi.number().integer().min(1000).max(60000).optional(),
        MAX_RETRY_ATTEMPTS: Joi.number().integer().min(1).max(20).optional(),
        BACKOFF_BASE: Joi.number().integer().min(1).max(10).optional(),
        MAX_RETRY_DELAY_MS: Joi.number().integer().min(1000).max(300000).optional(),
        CRITICAL_MAX_ATTEMPTS: Joi.number().integer().min(1).max(10).optional(),
        FAST_OPERATION_THRESHOLD_MS: Joi.number().integer().min(10).max(1000).optional(),
        NORMAL_OPERATION_THRESHOLD_MS: Joi.number().integer().min(100).max(5000).optional(),
        SLOW_OPERATION_THRESHOLD_MS: Joi.number().integer().min(500).max(30000).optional(),
        VERY_SLOW_OPERATION_THRESHOLD_MS: Joi.number().integer().min(1000).max(60000).optional(),
        CRITICAL_OPERATION_THRESHOLD_MS: Joi.number().integer().min(5000).max(300000).optional(),
        LOW_MEMORY_THRESHOLD_MB: Joi.number().integer().min(10).max(1000).optional(),
        NORMAL_MEMORY_THRESHOLD_MB: Joi.number().integer().min(50).max(2000).optional(),
        HIGH_MEMORY_THRESHOLD_MB: Joi.number().integer().min(100).max(8000).optional(),
        CRITICAL_MEMORY_THRESHOLD_MB: Joi.number().integer().min(200).max(16000).optional(),
        ...
        MIN_CONNECTION_POOL_SIZE: Joi.number().integer().min(1).max(50).optional(),
        MAX_CONNECTION_POOL_SIZE: Joi.number().integer().min(5).max(500).optional(),
        ...
        MASSIVE_SIZE_LIMIT: Joi.number().integer().min(1000).max(500000).optional(),
      }).unknown(true),
    }),
  ],
  providers: [
