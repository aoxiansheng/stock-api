 ...
 * 指标名称常量
 */
export const COLLECT_METRIC_NAMES = Object.freeze({
  // API 请求指标
 ...
 * 指标单位常量
 */
export const COLLECT_METRIC_UNITS = Object.freeze({
  MILLISECONDS: "ms",
  SECONDS: "seconds",
  BYTES: "bytes",
  PERCENT: "percent",
 ...
 */
export const COLLECT_METRIC_HEALTH_SCORE_CONFIG = {
  errorRate: {
    weight: 30, // 错误率最大扣30分
  ...
  responseTime: {
    ...
    tiers: [
      ...
      {
        threshold:
          PERFORMANCE_CONSTANTS.RESPONSE_TIME_THRESHOLDS.SLOW_REQUEST_MS / 2,
        penalty: 0.6,
      }, // 超过阈值的一半，扣60%
      {
        threshold:
          PERFORMANCE_CONSTANTS.RESPONSE_TIME_THRESHOLDS.SLOW_REQUEST_MS / 5,
        penalty: 0.4,
      }, // 超过阈值的1/5，扣40%
    ],
  },
  cpuUsage: {
    ...
    tiers: [
      {
        threshold:
          PERFORMANCE_CONSTANTS.MEMORY_THRESHOLDS.HIGH_MEMORY_USAGE_MB / 1000 +
          0.1,
        penalty: 1.0,
      }, // 超过高CPU阈值10%，扣100%
      {
  ...
  dbPerformance: {
    ...
    tiers: [
      {
        threshold: PERFORMANCE_CONSTANTS.RESPONSE_TIME_THRESHOLDS.SLOW_QUERY_MS,
        penalty: 1.0,
      },
      {
        threshold:
          PERFORMANCE_CONSTANTS.RESPONSE_TIME_THRESHOLDS.SLOW_QUERY_MS / 2,
        penalty: 0.5,
      },
    ],
  },
 ...
 * 默认配置值
 */
export const COLLECT_METRIC_PERFORMANCE_DEFAULTS = Object.freeze({
 ...
 * 事件名称常量
 */
export const COLLECT_METRIC_PERFORMANCE_EVENTS = Object.freeze({
