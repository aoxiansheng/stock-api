...
export class MetricsHelper {
   ...
   */
  static inc(
    registry: MonitoringRegistryService, 
    name: string, 
    labels?: object, 
    value: number = 1,
    legacyCallback?: () => void
   ...
   * @param name 指标名称
   */
  static getCounter(registry: MonitoringRegistryService, name: string) {
   ...
   * @param name 指标名称
   */
  static getGauge(registry: MonitoringRegistryService, name: string) {
    return registry[name];
  }
   ...
   * @param name 指标名称
   */
  static getHistogram(registry: MonitoringRegistryService, name: string) {
    return registry[name];
  }
