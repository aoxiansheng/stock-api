 ...
 */
export function deepFreeze<T>(object: T, visited: WeakSet<object> = new WeakSet()): T {
  // 空值检查
 ...
 */
export function isDeepFrozen(object: unknown, visited: WeakSet<object> = new WeakSet()): boolean {
  // 空值或非对象非函数类型视为已冻结
  if (object === null || object === undefined || 
