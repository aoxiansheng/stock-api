...
import { PERMISSION_MESSAGES } from "./message-semantics.constants";
...
export const DB_ERROR_MESSAGES = deepFreeze({
  ...
  BAD_QUERY: "数据库查询条件错误",
  INSUFFICIENT_PERMISSIONS: PERMISSION_MESSAGES.DB_ACCESS_DENIED,
...
export const HTTP_ERROR_MESSAGES = deepFreeze({
  // 4xx 客户端错误
  BAD_REQUEST: "请求参数错误",
  HTTP_UNAUTHORIZED: MESSAGE_SEMANTICS.PERMISSION.UNAUTHORIZED_ACCESS, // 使用统一基础消息
  FORBIDDEN: "访问被禁止",
