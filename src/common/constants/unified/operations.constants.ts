...
// 导出类型定义
export type CrudMessage = typeof OPERATION_CONSTANTS.CRUD_MESSAGES[keyof typeof OPERATION_CONSTANTS.CRUD_MESSAGES];
export type OperationType = typeof OPERATION_CONSTANTS.OPERATION_TYPES[keyof typeof OPERATION_CONSTANTS.OPERATION_TYPES];
export type DataState = typeof OPERATION_CONSTANTS.DATA_STATES[keyof typeof OPERATION_CONSTANTS.DATA_STATES];
export type PriorityLevel = typeof OPERATION_CONSTANTS.PRIORITY_LEVELS[keyof typeof OPERATION_CONSTANTS.PRIORITY_LEVELS];
export type QualityLevel = typeof OPERATION_CONSTANTS.QUALITY_LEVELS[keyof typeof OPERATION_CONSTANTS.QUALITY_LEVELS];
export type ProcessingMode = typeof OPERATION_CONSTANTS.PROCESSING_MODES[keyof typeof OPERATION_CONSTANTS.PROCESSING_MODES];
export type NotificationType = typeof OPERATION_CONSTANTS.NOTIFICATION_TYPES[keyof typeof OPERATION_CONSTANTS.NOTIFICATION_TYPES];
...
export function getSuccessMessage(operationType: OperationType): string {
  ...
  return messageMap[operationType] || OPERATION_CONSTANTS.CRUD_MESSAGES.PROCESSING_COMPLETED;
}
...
export function getFailureMessage(operationType: OperationType): string {
  ...
  return messageMap[operationType] || OPERATION_CONSTANTS.CRUD_MESSAGES.PROCESSING_FAILED;
}
...
export function isQueryOperation(operationType: OperationType): boolean {
  const queryOperations: OperationType[] = ['read', 'query', 'search', 'filter', 'aggregate'];
...
export function isMutationOperation(operationType: OperationType): boolean {
  const mutationOperations: OperationType[] = [
    'create', 'update', 'delete', 'batch_create', 'batch_update', 'batch_delete',
    'import', 'sync', 'backup', 'restore', 'cleanup'
  ];
...
export function isBatchOperation(operationType: OperationType): boolean {
  return operationType.startsWith('batch_') || 
