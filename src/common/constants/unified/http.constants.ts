...
// 导出类型定义
export type HttpStatusCode = typeof HTTP_CONSTANTS.STATUS_CODES[keyof typeof HTTP_CONSTANTS.STATUS_CODES];
export type ErrorMessage = typeof HTTP_CONSTANTS.ERROR_MESSAGES[keyof typeof HTTP_CONSTANTS.ERROR_MESSAGES];
export type SuccessMessage = typeof HTTP_CONSTANTS.SUCCESS_MESSAGES[keyof typeof HTTP_CONSTANTS.SUCCESS_MESSAGES];
 ...
 * 根据状态码获取对应的错误类型
 */
export function getErrorTypeByStatusCode(statusCode: number): 'client' | 'server' | 'unknown' {
