 ...
 * 提供人类可读的描述信息
 */
export const MAPPING_RULE_CATEGORY_DESCRIPTIONS: Record<MappingRuleCategory, string> = {
 ...
 */
export function isValidMappingRuleCategory(value: unknown): value is MappingRuleCategory {
  return typeof value === 'string' && MappingRuleCategoryValues.includes(value as MappingRuleCategory);
}