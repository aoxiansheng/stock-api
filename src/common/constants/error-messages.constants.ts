...
import { QUICK_MESSAGES, MESSAGE_TEMPLATES } from "./unified/message-templates.constants";
import { PERMISSION_MESSAGES } from "./unified/permission-message.constants";
import { BASE_MESSAGES } from "./unified/base.constants";

// 📢 认证和授权错误消息
export const AUTH_ERROR_MESSAGES = deepFreeze({
  // 通用认证错误
  UNAUTHORIZED_ACCESS: BASE_MESSAGES.PERMISSION.UNAUTHORIZED_ACCESS,
...
export const SYSTEM_ERROR_MESSAGES = deepFreeze({
  ...
  SERVICE_UNAVAILABLE: QUICK_MESSAGES.SERVICE_UNAVAILABLE,
  ...
  DB_UNAVAILABLE: QUICK_MESSAGES.DATABASE_UNAVAILABLE,
...
export const HTTP_ERROR_MESSAGES = deepFreeze({
  // 4xx 客户端错误
  BAD_REQUEST: "请求参数错误",
  HTTP_UNAUTHORIZED: BASE_MESSAGES.PERMISSION.UNAUTHORIZED_ACCESS, // 使用统一基础消息
  FORBIDDEN: "访问被禁止",
  ...
  BAD_GATEWAY: "网关错误",
  HTTP_SERVICE_UNAVAILABLE: QUICK_MESSAGES.API_SERVICE_UNAVAILABLE, // 使用模板，避免重复定义
