...
import { NotificationType, AlertSeverity, Alert, AlertRule, NotificationResult, NotificationSender } from '../../types/alert.types';
  ...
  async send(
    ...
    try {
      ...
      if (!urlValidation.valid) {
        throw new BadRequestException(`Slack Webhook URL安全检查失败: ${urlValidation.error}`);
      }
