...
import { IsString, IsNumber, IsBoolean, IsOptional, IsObject, IsArray, IsEnum, IsDateString } from 'class-validator';
...
export class CreateAlertDataDto {
  ...
  @ApiProperty({ description: '告警级别', enum: ['critical', 'warning', 'info'] })
