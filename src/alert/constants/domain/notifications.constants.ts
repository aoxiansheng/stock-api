...
export const NOTIFICATION_CONSTANTS = Object.freeze({
  ...
  VALIDATION: {
    ...
    VARIABLE_NAME_MIN_LENGTH: 1,     // 1
    VARIABLE_NAME_MAX_LENGTH: 50,        // 50
    
    // 模板验证
    TEMPLATE_MIN_LENGTH: 1,          // 1
    TEMPLATE_MAX_LENGTH: 10000,        // 10000
    MIN_TEMPLATE_LENGTH: 1,          // 1
    MAX_TEMPLATE_LENGTH: 10000,        // 10000
   ...
   */
  TIMEOUTS: {
    SEND_TIMEOUT_MS: 30000,      // 30000ms
    BATCH_TIMEOUT_MS: 60000,   // 60000ms
