...
export class AlertPerformanceConfig {
  ...
  queueSizeLimit: number =
    parseInt(process.env.ALERT_QUEUE_SIZE_LIMIT, 10) || 100;
  ...
  rateLimitPerMinute: number =
    parseInt(process.env.ALERT_RATE_LIMIT_PER_MINUTE, 10) || 100;
  ...
  connectionPoolSize: number =
    parseInt(process.env.ALERT_CONNECTION_POOL_SIZE, 10) || 10;
}
