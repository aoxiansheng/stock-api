...
|------|------|
| 扫描文件总数 | 597 |
| 使用processingTime的文件 | 23 |
| 使用processingTimeMs的文件 | 39 |
| 同时使用两个字段的文件 | 21 |
| processingTime引用总数 | 143 |
| processingTimeMs引用总数 | 173 |
| **迁移进度** | **55%** |
...
- **src/core/05-caching/common-cache/services/common-cache.service.ts**: 文件同时使用两个字段，建议清理processingTime字段
