  ...
  describe('isJwtExpiryTooLong method', () => {
    ...
    describe('invalid formats', () => {
      ...
      it('should reject object and array inputs', () => {
        ...
        expect(service['isJwtExpiryTooLong']([] as any)).toBe(true);
        expect(service['isJwtExpiryTooLong']({ expiry: '1d' } as any)).toBe(true);
      });
    });
    ...
    describe('regex edge cases', () => {
      ...
      it('should handle very long numeric strings', () => {
        expect(service['isJwtExpiryTooLong']('999999999999999999999d')).toBe(true);
        expect(service['isJwtExpiryTooLong']('123456789012345678901h')).toBe(true);
      });
