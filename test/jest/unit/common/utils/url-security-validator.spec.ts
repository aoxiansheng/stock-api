...
describe('URLSecurityValidator', () => {
  ...
  describe('validateURL', () => {
    ...
    it('should return invalid for non-standard ports', () => {
      const result = URLSecurityValidator.validateURL('https://hooks.slack.com:22/services/123');
      expect(result.valid).toBe(false);
    ...
    it('should return invalid for suspicious path patterns', () => {
        const result = URLSecurityValidator.validateURL('https://hooks.slack.com/../../etc/passwd');
        expect(result.valid).toBe(false);
