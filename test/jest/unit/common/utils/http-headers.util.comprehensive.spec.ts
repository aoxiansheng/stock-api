...
describe('HttpHeadersUtil - Comprehensive Coverage', () => {
  ...
  describe('getHeader', () => {
    ...
    it('should handle case-insensitive header lookup', () => {
      ...
      const result1 = HttpHeadersUtil.getHeader(mockRequest as Request, 'content-type');
      const result2 = HttpHeadersUtil.getHeader(mockRequest as Request, 'x-custom-header');
    ...
    it('should handle array header values by returning first non-empty value', () => {
      ...
      const result = HttpHeadersUtil.getHeader(mockRequest as Request, 'accept');
    ...
    it('should preserve whitespace in header values', () => {
      ...
      const result = HttpHeadersUtil.getHeader(mockRequest as Request, 'authorization');
  ...
  describe('getRequiredHeader', () => {
    it('should return header value when present', () => {
      ...
      const result = HttpHeadersUtil.getRequiredHeader(mockRequest as Request, 'X-Required');
    ...
    it('should throw custom error when header is missing', () => {
      ...
      expect(() => {
        HttpHeadersUtil.getRequiredHeader(mockRequest as Request, 'X-Required', 'Custom error message');
  ...
  describe('getMultipleHeaders', () => {
    it('should return array for array header values', () => {
      ...
      const result = HttpHeadersUtil.getMultipleHeaders(mockRequest as Request, 'Accept');

      expect(result).toEqual(['application/json', 'text/html', '  text/plain  ']);
    });
  ...
  describe('getClientIP', () => {
    ...
    it('should handle IPv6 addresses', () => {
      mockRequest.get = jest.fn().mockImplementation((header) => {
        if (header === 'x-forwarded-for') return '2001:0db8:85a3:0000:0000:8a2e:0370:7334';
        return undefined;
      });
  ...
  describe('getSecureClientIdentifier', () => {
    ...
    it('should hash user agent consistently', () => {
      ...
      const result1 = HttpHeadersUtil.getSecureClientIdentifier(mockRequest as Request);
      const result2 = HttpHeadersUtil.getSecureClientIdentifier(mockRequest as Request);
