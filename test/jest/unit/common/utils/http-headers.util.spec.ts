...
describe('HttpHeadersUtil', () => {
  ...
  describe('getRequiredHeader', () => {
    it('应该返回存在的必需header', () => {
      ...
      const result = HttpHeadersUtil.getRequiredHeader(mockRequest, 'required-header');
    ...
    it('应该在header不存在时抛出错误', () => {
      ...
      expect(() => HttpHeadersUtil.getRequiredHeader(mockRequest, 'missing-header'))
    ...
    it('应该使用自定义错误消息', () => {
      ...
      expect(() => HttpHeadersUtil.getRequiredHeader(mockRequest, 'missing-header', '自定义错误'))
        .toThrow('自定义错误');
    });
    ...
    it('应该在header值为空字符串时抛出错误', () => {
      ...
      expect(() => HttpHeadersUtil.getRequiredHeader(mockRequest, 'empty-header'))
  ...
  describe('getMultipleHeaders', () => {
    it('应该返回数组形式的header值', () => {
      ...
      const result = HttpHeadersUtil.getMultipleHeaders(mockRequest, 'test-header');
    ...
    it('应该在header不存在时返回空数组', () => {
      ...
      const result = HttpHeadersUtil.getMultipleHeaders(mockRequest, 'missing-header');
  ...
  describe('getClientIP', () => {
    ...
    it('应该处理包含多个IP的x-forwarded-for', () => {
      const mockRequest = {
        get: jest.fn((header) => {
          if (header === 'x-forwarded-for') return '192.168.1.1, 10.0.0.1, 172.16.0.1';
          return undefined;
        }),
        headers: {},
      } as any;
