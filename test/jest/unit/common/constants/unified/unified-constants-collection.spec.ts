...
describe("UNIFIED_CONSTANTS", () => {
  ...
  it("should be a deeply frozen object", () => {
    ...
    if (
      ...
      typeof UNIFIED_CONSTANTS.SYSTEM === "object"
    ) {
      const originalOperationStatus = (UNIFIED_CONSTANTS.SYSTEM as any)
        .OPERATION_STATUS;
      try {
        (UNIFIED_CONSTANTS.SYSTEM as any).OPERATIONSTATUS = {};
        expect((UNIFIED_CONSTANTS.SYSTEM as any).OPERATION_STATUS).toBe(
