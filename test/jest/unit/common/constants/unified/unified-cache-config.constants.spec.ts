...
describe('CACHE_CONSTANTS', () => {
  ...
  describe('STRATEGY_CONFIG', () => {
    it('should have cache strategy configurations', () => {
      expect(CACHE_CONSTANTS.STRATEGY_CONFIG.EVICTION_POLICY).toBe('allkeys-lru');
  ...
  describe('MONITORING_CONFIG', () => {
    it('should have monitoring configurations', () => {
      ...
      expect(CACHE_CONSTANTS.MONITORING_CONFIG.ALERT_THRESHOLD_PERCENT).toBe(90);
    });
  });
});
...
describe('shouldCompress', () => {
  it('should return true when size exceeds threshold and compression enabled', () => {
    const threshold = CACHE_CONSTANTS.SIZE_LIMITS.COMPRESSION_THRESHOLD_KB * 1024;
