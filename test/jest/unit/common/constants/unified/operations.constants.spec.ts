...
describe('OPERATION_CONSTANTS', () => {
  describe('CRUD_MESSAGES', () => {
    ...
    it('should have validation messages', () => {
      expect(OPERATION_CONSTANTS.CRUD_MESSAGES.VALIDATION_FAILED).toBe('数据验证失败');
      expect(OPERATION_CONSTANTS.CRUD_MESSAGES.VALIDATION_SUCCESS).toBe('数据验证成功');
    });

    it('should have resource status messages', () => {
      expect(OPERATION_CONSTANTS.CRUD_MESSAGES.RESOURCE_NOT_FOUND).toBe('资源不存在');
      expect(OPERATION_CONSTANTS.CRUD_MESSAGES.RESOURCE_ALREADY_EXISTS).toBe('资源已存在');
      expect(OPERATION_CONSTANTS.CRUD_MESSAGES.PERMISSION_DENIED).toBe('权限不足');
    });
  ...
  describe('OPERATION_TYPES', () => {
    ...
    it('should have batch operations', () => {
      expect(OPERATION_CONSTANTS.OPERATION_TYPES.BATCH_CREATE).toBe('batch_create');
      expect(OPERATION_CONSTANTS.OPERATION_TYPES.BATCH_UPDATE).toBe('batch_update');
      expect(OPERATION_CONSTANTS.OPERATION_TYPES.BATCH_DELETE).toBe('batch_delete');
    });
