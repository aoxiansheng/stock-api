...
describe('NotificationConfig', () => {
  ...
  describe('template functionality', () => {
    ...
    it('should handle missing tags gracefully', () => {
      ...
      const tagSectionMatch = defaultTemplate.match(/{{#if tags}}[\s\S]*?{{\/if}}/);
    ...
    it('should provide clear field labels', () => {
      ...
      const variables = [
        'ruleName', 'metric', 'value', 'threshold', 'severity',
        'status', 'startTime', 'duration', 'message'
      ];
  ...
  describe('localization support', () => {
    ...
    it('should maintain consistent punctuation', () => {
      ...
      const colonLines = defaultTemplate.split('\n').filter(line => line.includes(':'));
