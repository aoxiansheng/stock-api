...
describe('AlertConfig', () => {
  ...
  describe('time-based calculations', () => {
    ...
    it('should validate duration limits are reasonable', () => {
      ...
      expect(config.validation.duration.min).toBeLessThan(config.validation.duration.max);
    });
    ...
    it('should validate cooldown limits are reasonable', () => {
      ...
      expect(config.validation.cooldown.min).toBeLessThanOrEqual(config.validation.cooldown.max);
    });
  });
