import { getAutoInitConfig, PRESET_FIELD_DEFINITIONS } from '../../../../../src/common/config/auto-init.config';
...
describe('AutoInitConfig', () => {
  ...
  describe('PRESET_FIELD_DEFINITIONS', () => {
    it('should contain stockQuote definition', () => {
      ...
      expect(PRESET_FIELD_DEFINITIONS.stockQuote.ruleListType).toBe('quote_fields');
      expect(Array.isArray(PRESET_FIELD_DEFINITIONS.stockQuote.fields)).toBe(true);
    });
    ...
    it('should contain stockBasicInfo definition', () => {
      ...
      expect(PRESET_FIELD_DEFINITIONS.stockBasicInfo.ruleListType).toBe('basic_info_fields');
      expect(Array.isArray(PRESET_FIELD_DEFINITIONS.stockBasicInfo.fields)).toBe(true);
    });
    ...
    it('should have consistent field mapping structure', () => {
      ...
      definitions.forEach(definition => {
        ...
        expect(definition).toHaveProperty('ruleListType');
