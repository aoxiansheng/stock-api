...
import { PerformanceMetricsRepository } from "../../../../../../src/system-status/collect-metrics/repositories/performance-metrics.repository";
import {
  PERFORMANCE_LIMITS,
  METRIC_NAMES,
  METRIC_UNITS,
  ...
  PERFORMANCE_EVENTS,
  API_KEY_CONSTANTS,
} from "../../../../../../src/system-status/collect-metrics/constants/metrics-performance.constants";
import { PERFORMANCE_CONSTANTS } from "../../../../../../src/common/constants/unified";
import {
  AuthType,
  AuthStatus,
  OperationStatus,
} from "../../../../../../src/system-status/collect-metrics/enums/auth-type.enum";
import { FormatUtils } from "../../../../../../src/system-status/collect-metrics/utils/format.util";
...
describe("MetricsPerformanceService - Comprehensive Coverage", () => {
  let service: MetricsPerformanceService;
  ...
  beforeEach(async () => {
    ...
    service = module.get<MetricsPerformanceService>(MetricsPerformanceService);
