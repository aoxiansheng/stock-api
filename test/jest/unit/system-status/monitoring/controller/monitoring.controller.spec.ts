...
describe("MonitoringController", () => {
  ...
  let performanceAnalytics: jest.Mocked<IPerformanceAnalytics>;
  let healthAnalytics: jest.Mocked<IHealthAnalytics>;
  ...
  beforeEach(async () => {
    const mockPerformanceAnalyticsProvider = {
      ...
      invalidateCache: jest.fn().mockResolvedValue(void 0),
      calculateTrends: jest.fn().mockResolvedValue({
        cpuTrend: 'stable',
        memoryTrend: 'stable', 
    ...
    const mockHealthAnalyticsProvider = {
      getHealthScore: jest.fn().mockResolvedValue(95),
      ...
      providers: [
        {
          ...
          useValue: mockPerformanceAnalyticsProvider,
        },
        {
          provide: 'IHealthAnalytics',
          useValue: mockHealthAnalyticsProvider,
        },
    ...
    performanceAnalytics = module.get('IPerformanceAnalytics');
    healthAnalytics = module.get('IHealthAnalytics');
  ...
  describe("getPerformanceMetrics", () => {
    it("should return performance metrics successfully", async () => {
      ...
      expect(performanceAnalytics.getPerformanceSummary).toHaveBeenCalledWith(
        queryDto.startDate,
        queryDto.endDate,
      );
    });
  ...
  describe("getEndpointMetrics", () => {
    it("should return endpoint metrics sorted by totalRequests", async () => {
      ...
      expect(performanceAnalytics.getEndpointMetrics).toHaveBeenCalledTimes(1);
    });
  ...
  describe("Error Handling and Edge Cases", () => {
    describe("getPerformanceMetrics", () => {
      it("should throw error when performance monitor returns null", async () => {
        performanceAnalytics.getPerformanceSummary.mockResolvedValue(null);
      ...
      it("should handle missing healthScore and set default", async () => {
        ...
        performanceAnalytics.getPerformanceSummary.mockResolvedValue(
          incompleteMetrics,
        );
      ...
      it("should handle service errors and re-throw", async () => {
        ...
        performanceAnalytics.getPerformanceSummary.mockRejectedValue(error);
    ...
    describe("getEndpointMetrics", () => {
      ...
      it("should handle non-array response from performance monitor", async () => {
        performanceAnalytics.getEndpointMetrics.mockResolvedValue({} as any);
      ...
      it("should sort by averageResponseTime", async () => {
        ...
        performanceAnalytics.getEndpointMetrics.mockResolvedValue(
          unsortedMetrics,
        );
      ...
      it("should handle service errors", async () => {
        ...
        performanceAnalytics.getEndpointMetrics.mockRejectedValue(error);
    ...
    describe("getDatabaseMetrics", () => {
      it("should throw error when database metrics are null", async () => {
        performanceAnalytics.getDatabaseMetrics.mockResolvedValue(null);
      ...
      it("should provide default values for missing fields", async () => {
        ...
        performanceAnalytics.getDatabaseMetrics.mockResolvedValue(
      ...
      it("should handle service errors", async () => {
        ...
        performanceAnalytics.getDatabaseMetrics.mockRejectedValue(error);
    ...
    describe("getRedisMetrics", () => {
      it("should throw error when Redis metrics are null", async () => {
        performanceAnalytics.getRedisMetrics.mockResolvedValue(null);
      ...
      it("should provide default values for missing fields", async () => {
        ...
        performanceAnalytics.getRedisMetrics.mockResolvedValue(
          incompleteMetrics as any,
        );
      ...
      it("should handle service errors", async () => {
        ...
        performanceAnalytics.getRedisMetrics.mockRejectedValue(error);
    ...
    describe("getSystemMetrics", () => {
      it("should throw error when system metrics are null", async () => {
        performanceAnalytics.getSystemMetrics.mockReturnValue(null);
      ...
      it("should add computed fields", async () => {
        ...
        performanceAnalytics.getSystemMetrics.mockReturnValue(systemMetrics);
      ...
      it("should handle service errors", async () => {
        ...
        performanceAnalytics.getSystemMetrics.mockImplementation(() => {
          throw error;
        });
    ...
    describe("getOptimizationRecommendations", () => {
      it("should handle performance monitor errors", async () => {
        performanceAnalytics.getPerformanceSummary.mockRejectedValue(
      ...
      it("should generate comprehensive recommendations", async () => {
        ...
        expect(result.recommendations[0].type).toBe("performance_monitoring");
