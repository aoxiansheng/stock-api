...
describe('AuthService Optimization Features', () => {
  ...
  describe('Enhanced Token Refresh', () => {
    ...
    it('should log token validation start', async () => {
      ...
      tokenService.verifyRefreshToken.mockResolvedValue({ sub: 'user123', username: 'testuser', role: UserRole.DEVELOPER });
      tokenService.validateUserFromPayload.mockResolvedValue({ username: 'testuser' } as any);
