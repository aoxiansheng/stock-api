import { Permission, UserRole, RolePermissions } from '../../../../../src/auth/enums/user-role.enum';
...
describe('JwtUserSubject', () => {
  ...
  describe('hasPermission()', () => {
    ...
    it('should return true for permissions the user role has', () => {
      ...
      expect(developerSubject.hasPermission(Permission.QUERY_EXECUTE)).toBe(true);
    ...
    it('should return false for permissions the user role does not have', () => {
      ...
      expect(developerSubject.hasPermission(Permission.USER_MANAGE)).toBe(false);
    });
  ...
  describe('hasAnyPermission()', () => {
    ...
    it('should return false when user has none of the specified permissions', () => {
      ...
      expect(developerSubject.hasAnyPermission(adminOnlyPermissions)).toBe(false);
    });
  ...
  describe('getDisplayName()', () => {
    ...
    it('should display different roles correctly', () => {
      ...
      roles.forEach((role) => {
        ...
        expect(subject.getDisplayName()).toBe(`JWT用户: user_${role} (${role})`);
      });
    });
  });
