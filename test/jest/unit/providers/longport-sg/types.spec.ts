...
describe("LongPort SG Types", () => {
  describe("LongportQuoteData", () => {
    ...
    describe("Basic Properties", () => {
      ...
      it("should support both number and string for price fields", () => {
        // Number values
        quoteData.last_done = 32.5;
        quoteData.prev_close = 32.0;
        quoteData.open = 32.1;
        quoteData.high = 32.8;
        quoteData.low = 31.9;
    ...
    describe("Optional Extended Quotes", () => {
      ...
      it("should support optional post_market_quote", () => {
        ...
        expect(quoteData.post_market_quote.last_done).toBe(32.6);
  ...
  describe("LongportExtendedQuote", () => {
    ...
    it("should support flexible price field types", () => {
      ...
      extendedQuote.high = 32.5;
      extendedQuote.low = 32.4;
      extendedQuote.prev_close = 32.5;
  ...
  describe("LongportBasicInfo", () => {
    ...
    it("should handle listing date format", () => {
      const validDateFormats = ["1999-07-23", "2020-01-15", "2010-12-31"];
    ...
    it("should handle financial metrics correctly", () => {
      ...
      expect(basicInfo.market_cap).toBeGreaterThan(
        basicInfo.shares_outstanding,
      );
    });
  });
