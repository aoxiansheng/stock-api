...
import { AlertRule, AlertRuleSchema } from '../../../../../src/alert/schemas/alert-rule.schema';
...
describe('AlertRuleSchema', () => {
  it('should create a valid AlertRule model', () => {
    ...
    expect((schemaDefinition.severity as any).default).toBe(AlertSeverity.WARNING);
  ...
  it('should have correct indexes', () => {
    ...
    const sortFn = (a, b) => JSON.stringify(a[0]).localeCompare(JSON.stringify(b[0]));
