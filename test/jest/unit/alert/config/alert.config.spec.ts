...
import alertConfig, {
  AlertConfigValidation,
  AlertConfig,
} from "../../../../../src/alert/config/alert.config";
...
describe("AlertConfig", () => {
  ...
  describe("AlertConfigValidation", () => {
    ...
    it("should validate evaluationInterval bounds", () => {
      const config = plainToClass(AlertConfigValidation, {
      ...
      const configMax = plainToClass(AlertConfigValidation, {
