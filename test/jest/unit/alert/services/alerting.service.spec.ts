...
import { AlertRule, AlertRuleDocument } from '../../../../../src/alert/schemas/alert-rule.schema';
...
describe('AlertingService', () => {
  ...
  describe('Rule Management', () => {
    ...
    it('should update an alert rule', async () => {
      ...
      // Assert
      expect(alertRuleRepository.update).toHaveBeenCalledWith('test-rule', updateDto);
  ...
  describe('Alert Management', () => {
    it('should acknowledge an alert', async () => {
      ...
      alertHistoryService.updateAlertStatus.mockResolvedValue(acknowledgedAlert);
    ...
    it('should resolve an alert', async () => {
      ...
      // Act
      const result = await service.resolveAlert('test-alert', 'test-user', 'test-rule-id');
