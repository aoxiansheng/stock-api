...
describe("PresenterController - Health Endpoints", () => {
  ...
  describe("getExtendedHealthStatus", () => {
    it("should return extended health status", async () => {
      ...
      extendedHealthService.getFullHealthStatus.mockResolvedValue(
        mockHealthStatus,
      );
      ...
      expect(extendedHealthService.getFullHealthStatus).toHaveBeenCalledTimes(
        1,
      );
    });
  ...
  describe("getConfigHealthStatus", () => {
    it("should return config health status", async () => {
      ...
      extendedHealthService.getConfigHealthStatus.mockResolvedValue(
        mockConfigHealth,
      );
      ...
      expect(extendedHealthService.getConfigHealthStatus).toHaveBeenCalledTimes(
        1,
      );
    });
  ...
  describe("getDependenciesHealthStatus", () => {
    it("should return dependencies health status", async () => {
      ...
      extendedHealthService.getDependenciesHealthStatus.mockResolvedValue(
        mockDependenciesHealth,
      );
  ...
  describe("performStartupCheck", () => {
    it("should perform startup check successfully", async () => {
      ...
      extendedHealthService.performStartupCheck.mockResolvedValue(
        mockStartupResult,
      );
      ...
      expect(extendedHealthService.performStartupCheck).toHaveBeenCalledTimes(
        1,
      );
    });
  ...
  describe("health endpoints integration", () => {
    ...
    it("should call appropriate service methods", async () => {
      ...
      expect(
        extendedHealthService.getDependenciesHealthStatus,
      ).toHaveBeenCalled();
  ...
  describe("error handling", () => {
    it("should propagate service errors", async () => {
      ...
      await expect(controller.getExtendedHealthStatus()).rejects.toThrow(
        "Service error",
      );
    });
    ...
    it("should handle config validation errors", async () => {
      ...
      await expect(controller.getConfigHealthStatus()).rejects.toThrow(
    ...
    it("should handle startup check errors", async () => {
      ...
      await expect(controller.performStartupCheck()).rejects.toThrow(
