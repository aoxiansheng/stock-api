...
describe("MarketStatusService", () => {
  ...
  describe("getMarketStatus", () => {
    ...
    it("should handle provider market status integration", async () => {
      ...
      const spy = jest
        .spyOn(service as any, "getProviderMarketStatus")
    ...
    it("should handle provider market status with conflicting data", async () => {
      ...
      jest
        .spyOn(service as any, "getProviderMarketStatus")
        .mockResolvedValue(mockProviderStatus);
  ...
  describe("checkTradingSessions", () => {
    ...
    it("should handle multiple trading sessions (lunch break)", () => {
      ...
      const lunchResult = (service as any).checkTradingSessions(
        "12:30",
        config,
      );
  ...
  describe("Utility Methods", () => {
    ...
    it("should detect daylight saving time correctly", () => {
      ...
      const isDSTSummer = (service as any).isDaylightSavingTime(
        summerDate,
        usConfig,
      );
      const isDSTWinter = (service as any).isDaylightSavingTime(
        winterDate,
        usConfig,
      );
    ...
    it("should handle markets without DST support", () => {
      ...
      const isDST = (service as any).isDaylightSavingTime(
        summerDate,
        noDSTConfig,
      );
    ...
    it("should handle provider errors gracefully", async () => {
      ...
      jest
        ...
        .mockImplementation(async () => {
          ...
          (service as any).logger.warn("Provider市场状态获取失败", {
            market: Market.US,
            error: error.message,
          });
          return null;
  ...
  describe("mergeMarketStatus", () => {
    ...
    it("should merge provider status when available and different", () => {
      ...
      const result = (service as any).mergeMarketStatus(
        mockLocalStatus,
        providerStatus,
      );
  ...
  describe("Error Handling and Edge Cases", () => {
    ...
    it("should handle memory cleanup for cache", () => {
      ...
      expect((service as any).statusCache.size).toBeGreaterThan(
        initialCacheSize,
      );
    });
  });
