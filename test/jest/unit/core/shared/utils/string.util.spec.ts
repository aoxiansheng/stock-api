...
jest.mock('crypto', () => {
  const mockDigestValues = {
    ...
    'Test@123!\nNew-Line': '0e57f59a6247e4ab6025c57e5097cde41c553ad8eafb55290554a62fb9e07b15',
    ...
    createHash: jest.fn().mockImplementation(() => {
      ...
      const mockObj = {
        ...
        digest: jest.fn().mockImplementation((format) => {
          ...
          // 对于集成测试使用特定值
          if (inputStr === 'very similar string' || inputStr === 'a very similar string') {
  ...
  describe('calculateSimilarity', () => {
    describe('Edge Cases', () => {
      it('should return 0 for null/undefined strings', () => {
        ...
        expect(StringUtils.calculateSimilarity(undefined as any, 'test')).toBe(0);
        expect(StringUtils.calculateSimilarity('test', undefined as any)).toBe(0);
      });
    ...
    describe('Substring Matches', () => {
      it('should return 0.8 for substring matches', () => {
        expect(StringUtils.calculateSimilarity('hello', 'hello world')).toBe(0.8);
        expect(StringUtils.calculateSimilarity('world', 'hello world')).toBe(0.8);
        expect(StringUtils.calculateSimilarity('test string', 'test')).toBe(0.8);
      });
    ...
    describe('Levenshtein Distance Based Similarity', () => {
      ...
      it('should handle strings of different lengths', () => {
        const similarity = StringUtils.calculateSimilarity('short', 'much longer string');
    ...
    describe('Special Cases', () => {
      ...
      it('should handle numeric strings', () => {
        expect(StringUtils.calculateSimilarity('123', '124')).toBeGreaterThan(0.6);
        expect(StringUtils.calculateSimilarity('1000', '2000')).toBeGreaterThan(0.7);
      });
      ...
      it('should handle special characters', () => {
        ...
        expect(StringUtils.calculateSimilarity('hello-world', 'hello_world')).toBeCloseTo(1 - 1 / 11);
      });
    });
  });
  ...
  describe('generateSimpleHash', () => {
    ...
    describe('Basic Functionality', () => {
      ...
      it('should generate hash for complex strings', () => {
        const complexString = 'This is a complex string with 123 numbers and !@# symbols';
    ...
    describe('Edge Cases', () => {
      it('should handle null and undefined inputs gracefully', () => {
        ...
        expect(() => StringUtils.generateSimpleHash(undefined as any)).not.toThrow();
      });
