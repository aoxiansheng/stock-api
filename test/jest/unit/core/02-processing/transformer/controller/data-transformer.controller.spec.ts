...
describe('DataTransformerController', () => {
  ...
  describe('transform', () => {
    ...
    it('should transform data successfully', async () => {
      ...
      expect(dataTransformerService.transform).toHaveBeenCalledWith(mockDataTransformRequestDto);
  ...
  describe('transformBatch', () => {
    ...
    it('should transform batch data successfully', async () => {
      ...
      const result = await controller.transformBatch(mockDataTransformRequestDtos);
      expect(dataTransformerService.transformBatch).toHaveBeenCalledWith({ requests: mockDataTransformRequestDtos });
      expect(result).toEqual(mockResponse);
    });
