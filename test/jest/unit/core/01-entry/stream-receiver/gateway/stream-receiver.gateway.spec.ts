...
describe('StreamReceiverGateway', () => {
  ...
  describe('Connection Management', () => {
    it('should handle successful connection with valid credentials', async () => {
      ...
      expect(apiKeyService.validateApiKey).toHaveBeenCalledWith(mockApiKey, mockAccessToken);
  ...
  describe('Authentication and Authorization', () => {
    ...
    it('should check stream permissions correctly', () => {
      const mockApiKeyPermissions = [Permission.DATA_READ, Permission.STREAM_SUBSCRIBE];

      const hasPermission = (gateway as any).checkStreamPermissions(mockApiKeyPermissions);
  ...
  describe('Stream Subscription Handling', () => {
    ...
    it('should handle successful subscription', async () => {
      ...
      await gateway.handleSubscribe(mockSocket as unknown as Socket, subscriptionData);
    ...
    it('should handle successful unsubscription', async () => {
      ...
      await gateway.handleUnsubscribe(mockSocket as unknown as Socket, unsubscriptionData);
  ...
  describe('Error Handling and Edge Cases', () => {
    ...
    it('should handle malformed subscription data', async () => {
      ...
      await gateway.handleSubscribe(mockSocket as unknown as Socket, malformedData as any);
    ...
    it('should handle large symbol lists', async () => {
      const largeSymbolList = Array.from({ length: 1000 }, (_, i) => `TEST${i}.HK`);
    ...
    it('should handle socket disconnection during operation', async () => {
      ...
      await expect(
        gateway.handleSubscribe(mockSocket as unknown as Socket, subscriptionData)
