...
describe('SymbolMappingRepository', () => {
  ...
  beforeEach(async () => {
    ...
    const mockModel = Object.assign(
      ...
      }),
      {
        ...
        create: jest.fn().mockImplementation((dto) => Promise.resolve({ ...dto, _id: 'new-id' })),
  ...
  describe('updateById', () => {
    it('should update symbol mapping by ID', async () => {
      ...
      const result = await repository.updateById('507f1f77bcf86cd799439011', updateDto);
  ...
  describe('exists', () => {
    it('should return true if mapping exists', async () => {
      ...
      expect(model.countDocuments).toHaveBeenCalledWith({ dataSourceName: 'longport' });
    ...
    it('should return false if mapping does not exist', async () => {
      ...
      expect(model.countDocuments).toHaveBeenCalledWith({ dataSourceName: 'nonexistent' });
  ...
  describe('findAllMappingsForSymbols', () => {
    it('should find all mappings for given symbols', async () => {
      ...
      const result = await repository.findAllMappingsForSymbols('longport', symbols);
    ...
    it('should return empty array if no mappings found', async () => {
      ...
      const result = await repository.findAllMappingsForSymbols('nonexistent', symbols);
  ...
  describe('deleteByDataSource', () => {
    it('should delete all mappings for a data source', async () => {
      ...
      expect(model.deleteMany).toHaveBeenCalledWith({ dataSourceName: 'longport' });
  ...
  describe('updateMappingRule', () => {
    it('should update a specific mapping rule', async () => {
      ...
      const result = await repository.updateMappingRule('longport', 'AAPL', updatedRule);
