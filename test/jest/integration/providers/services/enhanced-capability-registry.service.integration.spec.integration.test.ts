...
const MOCK_PROVIDER_ONE_CAPS_PATH = path.join(
  MOCK_PROVIDER_ONEPATH,
  "capabilities",
);
...
describe("EnhancedCapabilityRegistryService Integration Test", () => {
  ...
  beforeAll(async () => {
    ...
    jest
      .spyOn(SmartPathResolver, "getProvidersPath")
      .mockReturnValue(MOCK_PROVIDERSDIR);
  ...
  beforeEach(async () => {
    ...
    service = module.get<EnhancedCapabilityRegistryService>(
