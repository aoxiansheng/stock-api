...
describe("MonitoringCacheService Integration Tests", () => {
  ...
  beforeEach(async () => {
    module = await Test.createTestingModule({
      ...
      providers: [CacheService, MonitoringCacheService],
    }).compile();
  ...
  describe("Health Data Integration", () => {
    it("should store and retrieve health data correctly", async () => {
      ...
      const retrievedData = await service.getHealthData(
  ...
  describe("Trend Data Integration", () => {
    it("should store and retrieve trend data correctly", async () => {
      ...
      const retrievedData = await service.getTrendData(
    ...
    it("should handle getOrSet for trend data with correct TTL", async () => {
      ...
      const result = await service.getOrSetTrendData(
        testKey,
        async () => testData,
      );
  ...
  describe("Performance Data Integration", () => {
    it("should store and retrieve performance data correctly", async () => {
      ...
      await service.setPerformanceData(
        "integration-test-performance",
        testPerfData,
      );
      const retrievedData = await service.getPerformanceData(
        "integration-test-performance",
      );
    ...
    it("should handle getOrSet for performance data with shortest TTL", async () => {
      ...
      const result = await service.getOrSetPerformanceData(
        testKey,
        async () => testData,
      );
      expect(result).toEqual(testData);
  ...
  describe("Cache Invalidation Integration", () => {
    beforeEach(async () => {
      ...
      await service.setTrendData("test-trend-1", {
        responseTime: { current: 100 },
      });
      await service.setTrendData("test-trend-2", {
        responseTime: { current: 120 },
      });
  ...
  describe("Namespace Isolation Integration", () => {
    it("should isolate monitoring cache from other cache usage", async () => {
      ...
      const separateMonitoringResult = await service.getHealthData(
        separateMonitoringKey,
      );
  ...
  describe("Error Handling Integration", () => {
    it("should handle cache failures gracefully", async () => {
      ...
      await expect(
        service.setHealthData("problematic", problematic),
