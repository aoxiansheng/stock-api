...
describe("Enhanced Authentication Integration Tests", () => {
  ...
  describe("Permission System", () => {
    ...
    beforeEach(async () => {
      ...
      const userId =
        registerResponse.body.data._id || registerResponse.body.data.id;
      readOnlyApiKey = await TestDataHelper.createReadOnlyApiKey(
        apiKeyModel,
        userId,
      );
      fullAccessApiKey = await TestDataHelper.createFullAccessApiKey(
        apiKeyModel,
        userId,
      );
