...
describe('Auth Configuration Deduplication Verification (Simplified)', () => {
  ...
  describe('统一配置系统验证', () => {
    ...
    it('应该提供所有主要配置接口', () => {
      ...
      console.log(`  - API_KEY_OPERATIONS: ${typeof wrapper.API_KEY_OPERATIONS}`);
    ...
    it('应该消除超时配置重叠', () => {
      ...
      const usageUpdateTimeout = wrapper.API_KEY_OPERATIONS.USAGE_UPDATE_TIMEOUT_MS;
      const validationTimeout = wrapper.API_KEY_OPERATIONS.VALIDATION_TIMEOUT_MS;
