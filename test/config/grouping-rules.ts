...
export const GROUPING_RULES = {
  ...
  functional_modules: {
    "auth": {
      ...
      submodules: ["login", "register", "jwt", "api-key", "rate-limit", "permissions"],
      priority: "critical"
    },
    "core": {
      description: "核心业务功能",
      submodules: ["receiver", "transformer", "query", "storage", "symbol-mapper", "data-mapper"],
      priority: "critical"
    },
    "common": {
      description: "共享组件和服务",
      submodules: ["cache", "database", "interceptors", "pipes", "filters", "decorators"],
      priority: "high"
    },
    "monitoring": {
      description: "监控和安全相关",
  ...
  coverage_mapping: {
    ...
    "src/core/receiver/": {
      ...
      integration: [
        "test/jest/integration/core/receiver.integration.test.ts"
      ],
      e2e: [
        "test/jest/e2e/core/data-request.e2e.test.ts"
      ],
      performance: [
        "test/k6/load/data-flow/receiver-load.perf.test.js"
      ]
    },
    "src/core/transformer/": {
      ...
      e2e: [
        "test/jest/e2e/core/data-transform.e2e.test.ts"
      ]
    },
    "src/common/": {
      unit: [
      ...
      performance: [
        "test/k6/load/api/cache-load.perf.test.js"
      ]
    }
  }
} as const;
