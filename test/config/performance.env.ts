...
// MongoDB 测试数据库
process.env.MONGODB_URI_TEST = 'mongodb://localhost:27017/symbol-mapper-performance-test';
...
console.log(`📊 Cache config: Rules=${process.env.RULE_CACHE_MAX_SIZE}, Symbols=${process.env.SYMBOL_CACHE_MAX_SIZE}, Batch=${process.env.BATCH_RESULT_CACHE_MAX_SIZE}`);