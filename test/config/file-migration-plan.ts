  ...
  "test/integration/": {
    ...
    files: [
      ...
      },
      {
        ...
        target: "test/jest/integration/core/simple-integration.integration.test.ts",
        type: "move"
      },
      {
      ...
      },
      {
        ...
        target: "test/jest/integration/monitoring/monitoring-security.integration.test.ts",
        type: "move"
      },
      {
        source: "services/performance.integration.test.ts",
        target: "test/jest/integration/monitoring/performance.integration.test.ts",
        type: "move"
      }
    ]
  },
...
export type MigrationAction = "split" | "reorganize" | "migrate" | "consolidate" | "move";
