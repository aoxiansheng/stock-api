...
import { MonitoringRegistryService } from '@monitoring/metrics/services/metrics-registry.service';
...
// 特别注意 MonitoringRegistryService、FeatureFlags、SymbolMappingRepository 的导入路径
...
private initializeNewMetrics(): void {
  // 如果决定使用新指标，需要在 MonitoringRegistryService 中注册
  // 示例：
  /*
